...
namespace MG.WebHost.Migrations
{
    ...
    [Migration("20220517195312_Added_TournamentId_To_News")]
    partial class Added_TournamentId_To_News
    {
            ...
            modelBuilder.Entity("MG.WebHost.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("22d3c683-ebc5-4809-aa2e-4b379d380324"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "93d9f810-ac22-46e6-a1a7-67f1c98a1e26",
                            CreatedDate = new DateTime(2022, 5, 17, 19, 53, 12, 184, DateTimeKind.Utc).AddTicks(7630),
                            Deleted = false,
                            ...
                            SecurityStamp = "64787ee8-e22e-4517-b6a0-8417990db8e6",
                            TwoFactorEnabled = false,
                            UpdatedDate = new DateTime(2022, 5, 17, 19, 53, 12, 184, DateTimeKind.Utc).AddTicks(7630),
                            UserTypes = 8
                        });
                });
            ...
            modelBuilder.Entity("MG.WebHost.Entities.News.News", b =>
                {
                    ...
                    b.HasOne("MG.WebHost.Entities.Tournaments.Tournament", null)
                        .WithMany()
