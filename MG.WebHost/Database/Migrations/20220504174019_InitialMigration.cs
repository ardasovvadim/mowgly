        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TournamentName = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NormalizedTournamentName = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MastersId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    SectionsId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SectionUser", x => new { x.MastersId, x.SectionsId });
                    table.ForeignKey(
                        name: "FK_SectionUser_AspNetUsers_MastersId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("e6654c2b-25e9-4ff5-bf4a-31f62b81c35f"), 0, null, "d8513d41-5855-405a-a970-1a31e61f26d3", new DateTime(2022, 5, 4, 17, 40, 19, 92, DateTimeKind.Utc).AddTicks(6270), false, "ardasovvadim@gmail.com", false, null, null, false, null, null, null, null, null, null, null, false, "d100671d-3a66-482c-86eb-059c1b052b4d", false, new DateTime(2022, 5, 4, 17, 40, 19, 92, DateTimeKind.Utc).AddTicks(6270), null, 8 });
