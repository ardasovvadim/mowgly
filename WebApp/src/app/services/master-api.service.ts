...
export class MasterApiService {
  ...
  public getCardMastersPage(searchCriteria: MasterSearchCriteria): Observable<Page<MasterVm>> {
    return this.api.post<Page<MasterVm>>(`${this.servicePrefix}/GetCardMastersBySearchCriteria`, searchCriteria);
  }
